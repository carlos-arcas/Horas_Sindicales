...
class MainWindow:
    ...
    def _update_action_state(self) -> None:
        ...
        self.eliminar_button.setText(copy_text("ui.historico.eliminar_boton").format(n=selected_count))
        self.generar_pdf_button.setText(copy_text("ui.historico.exportar_pdf_boton").format(n=selected_count))
