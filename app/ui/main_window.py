...
from app.ui.vistas.main_window.state_helpers import update_action_state
...
class MainWindow:
    ...
    def _update_action_state(self) -> None:
        ...
        active_step = self._resolve_operativa_step(
            form_valid and not has_blocking_errors,
            has_pending,
            self._selected_pending_solicitudes(),
            self.insertar_sin_pdf_button.isEnabled(),
        )
    ...
    def _update_stepper_state(
        ...
        stepper_message = first_blocking_error or form_message or copy_text("ui.solicitudes.stepper_mensaje_completar")
