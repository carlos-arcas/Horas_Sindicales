...
def build_main_window_widgets(window: "MainWindow") -> None:
    ...
    window._historico_refresh_timer = QTimer(window)
    window._historico_refresh_timer.setSingleShot(True)
    window._historico_refresh_timer.timeout.connect(window._aplicar_filtros_historico)
    ...
    window.historico_search_input.textChanged.connect(window._on_historico_search_changed)
