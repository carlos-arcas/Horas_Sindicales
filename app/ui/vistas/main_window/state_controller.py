...
from app.ui.i18n_interfaz import cambiar_idioma_interfaz, configurar_interfaz_i18n, registrar_refresco_idioma, texto_interfaz
...
class MainWindow(MainWindowStateActionsMixin, MainWindowStateValidationMixin, MainWindowHealthMixin, QMainWindow):
    def __init__(
        ...
        if servicio_i18n is not None:
            configurar_interfaz_i18n(servicio_i18n)
