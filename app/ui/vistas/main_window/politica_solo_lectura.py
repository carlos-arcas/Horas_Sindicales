...
ACCIONES_MUTANTES_AUDITADAS_UI: tuple[DescriptorAccionMutante, ...] = (
    DescriptorAccionMutante(
        "agregar_button", "widget", "solicitudes", "agregar_pendiente"
    ),
    DescriptorAccionMutante(
        "insertar_sin_pdf_button", "widget", "solicitudes", "confirmar_sin_pdf"
    ),
    DescriptorAccionMutante(
        "confirmar_button", "widget", "solicitudes", "confirmar_con_pdf"
    ),
    DescriptorAccionMutante(
    ...
    DescriptorAccionMutante(
        "add_persona_button", "widget", "configuracion", "crear_persona"
    ),
    DescriptorAccionMutante(
        "edit_persona_button", "widget", "configuracion", "editar_persona"
    ),
    DescriptorAccionMutante(
        "delete_persona_button", "widget", "configuracion", "desactivar_persona"
    ),
    DescriptorAccionMutante(
        "edit_grupo_button", "widget", "configuracion", "actualizar_configuracion_grupo"
    ),
    DescriptorAccionMutante(
        "editar_pdf_button", "widget", "configuracion", "actualizar_configuracion_pdf"
    ),
    DescriptorAccionMutante(
        "opciones_button", "widget", "sincronizacion", "actualizar_configuracion_sync"
    ),
    DescriptorAccionMutante(
        "config_sync_button",
        "widget",
    ...
    DescriptorAccionMutante(
        "sync_button", "widget", "sincronizacion", "sincronizar_ahora"
    ),
    DescriptorAccionMutante(
        "confirm_sync_button", "widget", "sincronizacion", "confirmar_sincronizacion"
    ),
    DescriptorAccionMutante(
        "retry_failed_button",
        "widget",
    ...
    DescriptorAccionMutante(
        "accion_menu_cargar_demo", "action", "menu_ayuda", "cargar_datos_demo"
    ),
    DescriptorAccionMutante(
        "eliminar_button", "widget", "historico", "eliminar_solicitud_historica"
    ),
    DescriptorAccionMutante(
        "generar_pdf_button", "widget", "historico", "exportar_historico_pdf"
    ),
)
