...
from app.application.use_cases.solicitudes.internals import MONTH_NAMES, _PathFileSystem, _generar_incident_id, _resolver_correlation_id, pdf_intro_text
from app.application.use_cases.solicitudes.helpers import _actualizar_pdf_en_repo, _build_periodo_filtro, _calcular_minutos, _calcular_saldos, _hash_file, _parse_year_month, _solapa_rango, hours_to_minutes, normalize_date, normalize_time, solicitud_key, total_cuadrante_por_fecha as _total_cuadrante_por_fecha
