...
def test_crear_solicitud_incrementa_count_en_repo() -> None:
    ...
    use_cases = SolicitudUseCases(solicitud_repo, persona_repo, fs=SistemaArchivosLocal(), politica_modo_solo_lectura=crear_politica_modo_solo_lectura(crear_estado_modo_solo_lectura(lambda: False)))
