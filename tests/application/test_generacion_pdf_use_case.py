...
def test_confirmar_lote_llama_puerto_pdf_con_datos_esperados(
    ...
    fake_pdf = FakeGeneradorPdf()
    use_case = SolicitudUseCases(solicitud_repo, persona_repo, generador_pdf=fake_pdf, fs=SistemaArchivosLocal(), politica_modo_solo_lectura=crear_politica_modo_solo_lectura(crear_estado_modo_solo_lectura(lambda: False)))
