...
def test_confirmar_lote_preflight_colision_se_resuelve_con_ruta_alternativa(connection, tmp_path: Path) -> None:
    ...
    use_case = SolicitudUseCases(solicitud_repo, persona_repo, generador_pdf=generador_pdf, fs=SistemaArchivosLocal(), politica_modo_solo_lectura=crear_politica_modo_solo_lectura(crear_estado_modo_solo_lectura(lambda: False)))
