...
def test_confirmar_lote_preflight_bloquea_si_pdf_ya_existe(connection, tmp_path: Path) -> None:
    ...
    with pytest.raises(BusinessRuleError, match="Colisión de ruta destino"):
