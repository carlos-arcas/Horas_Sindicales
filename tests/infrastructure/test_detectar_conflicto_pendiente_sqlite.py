...
def test_registro_confirmado_con_solape_no_bloquea_pendiente_nueva(solicitud_repo, persona_id: int) -> None:
    _crear_solicitud(
        solicitud_repo,
        persona_id=persona_id,
        fecha="2026-07-17",
...
def test_registro_confirmado_duplicado_exacto_no_bloquea_pendiente_nueva(solicitud_repo, persona_id: int) -> None:
    _crear_solicitud(
        solicitud_repo,
        persona_id=persona_id,
        fecha="2026-07-18",
    ...
    conflicto = solicitud_repo.detectar_conflicto_pendiente(persona_id, "2026-07-18", 8 * 60, 10 * 60, False)
...
def test_conflicto_si_solape_en_pendientes(solicitud_repo, persona_id: int) -> None:
    ...
    conflicto = solicitud_repo.detectar_conflicto_pendiente(persona_id, "2026-07-19", 10 * 60, 12 * 60, False)
