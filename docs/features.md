...
| FTR-005 | Gestión local de personajes del proyecto actual | DONE | LOGICA | tests/application/personajes/test_casos_uso_personajes.py<br>tests/domain/personajes/test_servicios_personaje.py | Módulo local sin vertical web: alta, edición, baja y listado de personajes asociados al proyecto actual. |
