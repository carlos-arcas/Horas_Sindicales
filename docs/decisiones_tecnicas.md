...
- 2026-03-02: Se completó el refactor de `MainWindow` extrayendo handlers de formulario, histórico y layout a mixins (`handlers_formulario.py`, `handlers_historico.py`, `handlers_layout.py`) para evitar errores de wiring por métodos faltantes y mantener MRO explícita. Verificación: `pytest tests/ui/test_required_handlers_mainwindow.py tests/ui/test_mainwindow_required_handlers_runtime.py tests/ui/test_main_window_confirmar_pdf.py`.
