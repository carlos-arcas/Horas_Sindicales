...
CATALOGO: dict[str, dict[str, str]] = {
    "es": {
        ...
        "bootstrap.config_pura": "Leyendo configuración inicial…",
        "bootstrap.ui_mount": "Montando interfaz principal…",
    ...
    "en": {
        ...
        "bootstrap.config_pura": "Reading initial configuration…",
        "bootstrap.ui_mount": "Mounting main interface…",
